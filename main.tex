...
\title{\large INTEGRASI DATA INBOUND PADA SAAT PENGUJIAN SMART CONVEYOR DAN SISTEM WAREHOUSE MANAGEMENT SYSTEM  \\[5ex]   %your thesis title,
\small{Laporan ini dibuat untuk memenuhi persyaratan kelulusan matakuliah\\[-4ex]
	Proyek 3}} %note \\[1ex] is a line break in the title

\author{\large\textbf{Alit Fajar Kurniawan}}             %your name
\college{\large\textbf{1.17.4.057}\\[5ex]}
...
\include{section/pengesahan}     %include a pengesahan.tex file

\addcontentsline{toc}{chapter}{LEMBAR PERNYATAAN}
\include{section/pernyataan}    %include a pernyataan.tex file
