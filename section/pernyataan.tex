...
\begin{table}[ht]
	\centering
	\begin{tabular}{lll}
		Nama     & : & Alit Fajar Kurniawan                                                                                                                             \\
		NPM       & : & 1.17.4.057                                                                                                                                    \\
		Judul TA & : & \begin{tabular}[c]{@{}l@{}}INTEGRASI DATA INBOUND PADA SAAT PENGUJIAN  \\ SMART CONVEYOR DAN SISTEM WAREHOUSE MANAGEMENT SYSTEM \end{tabular}
	\end{tabular}
\end{table}
